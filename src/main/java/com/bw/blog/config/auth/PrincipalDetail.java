package com.bw.blog.config.auth;
...
public class PrincipalDetail implements UserDetails {
	...
	// 계정이 갖고있는 권한 목록을 리턴한다. (권한이 여러개 있을 수 있어서 루프르르 돌아야 하는데 우리는 1개만)
	@Override
...
//				return "ROLE_"+user.getRole(); // "ROLE_"은 권한 부여 시 꼭 넣어야 하는 문자열 스프링 규칙 ROLE_USER
//			}
//		});
